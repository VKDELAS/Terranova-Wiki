...
import { Download, MessageCircle, BookOpen, AlertTriangle } from "lucide-react"
...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 pt-28 pb-16 text-center">
      {/* Background art */}
      <div className="absolute inset-0 -z-20">
        <Image src="/hero-bg.png" alt="" fill priority className="object-cover opacity-50" />
      </div>
      {/* Atmospheric gradient + ember glow */}
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-deep/70 via-deep/60 to-deep" />
      ...
      {/* WIP banner */}
      <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/10 px-4 py-1.5 text-xs font-medium text-gold sm:text-sm">
