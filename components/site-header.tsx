    ...
    <header className="header-drop fixed inset-x-0 top-3 z-50 px-3 sm:top-5 sm:px-4">
      <div className="mx-auto flex max-w-6xl items-center gap-4">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="flex h-14 items-center gap-2 rounded-full border border-edge/80 bg-deep/85 px-3 shadow-[0_8px_32px_rgba(0,0,0,0.45)] backdrop-blur-md sm:h-16 sm:px-4">
